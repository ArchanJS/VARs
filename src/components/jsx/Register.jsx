        ...
        <>
            <div className="container-fluid">
                <div className="row bg-dark">
                    ...
                    <input className="form-control my-3 w-75 mx-auto bg-dark" style={{color:"aqua"}} type="text" placeholder="Enter your full name" aria-label="default input example" />
                    ...
                    <input className="form-control my-3 w-75 mx-auto bg-dark" style={{color:"aqua"}} type="text" placeholder="Confirm password" aria-label="default input example" />
                    </form>
